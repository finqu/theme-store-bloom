...
> _Soft, playful, and full of character._ A warm, inviting theme that's equally at home with kids' products, fashion, and pet stores.

## About this theme

**Default market:** Kids and baby stores, children's clothing, toys, nursery furniture, and family-oriented retailers.

**Also works for:** Fashion boutiques, pet stores, stationery and gift shops, lifestyle brands, and any store that benefits from a friendly, approachable tone.

**Design character:** Bloom has a distinctive soft-lavender personality — its button accent color (#e7c5f8) and secondary background (#f6f3f6) create a delicate, welcoming mood without being loud. Typography is handled entirely by Jost at a slightly elevated scale (1.125×), giving headings an effortless, contemporary look with light font weight. Sharp, zero-radius layouts keep the design crisp and editorial.

**UI style:** Split-content hero sections work well for campaign imagery. Category carousels guide customers through collections, while product carousels showcase new arrivals. Sections feel airy and spacious thanks to above-average padding (5.72rem), giving the store a gallery-like quality.

**Best suited for:** Brands that want a warm, inviting storefront — from kids' collections and baby gear to fashion edits and pet supplies. The soft palette adapts to any friendly, lifestyle-oriented market through color and content changes.

**Available presets:** Default (Kids & Baby), Fashion, Pets.
